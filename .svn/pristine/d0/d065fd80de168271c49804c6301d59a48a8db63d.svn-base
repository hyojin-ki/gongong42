		...
		<div class="modal-content ">
			...
			<div class="modal-body open-image-modal">
				<div class="row" id="image-list-notice-modal">
					<div class="col-12 mb-5" id="image-list-notice-modal-class">
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-danger" data-dismiss="modal" id="image-btn-close" >닫기</button>
		...
		if (!count) {
			...
			$("#modal-emoticon-add-form .modal-body i").each(function(index, element) {
				if ($(element).hasClass("selected-emoticon")) {
					...
					addElement += "<div class='col-12'>"
					addElement += '<button type="button" style="margin-top: 7px; margin-left: 10px;" class="btn btn-success" id="modify-title-emoticon"'
