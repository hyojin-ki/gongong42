				...
				<div class="card border-0">
					...
					<div class="card-body">
						...
						<div class="form-row mb-4" >
							<div>
								<a href="snsTerm.do"><button type="button" class="btn btn-warning" style="width: 330px; height:50px; margin-left: 3.5px;">카카오 아이디로 로그인</button></a>
							</div>
						</div>
						<div class="form-row mb-4" >
							<div>
								<a href="snsTerm.do"><button type="button" class="btn btn-primary" style="width: 330px; height:50px; margin-left: 3.5px;">페이스북 아이디로 로그인</button></a>
							</div>
						</div>
						<div class="form-row mb-4" >
							<div>
								<a href="snsTerm.do"><button type="button" class="btn btn-success" style="width: 330px; height:50px; margin-left: 3.5px;">네이버 아이디로 로그인</button></a>
							</div>
						</div>
					</div>
				</div>
