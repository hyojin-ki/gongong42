		...
		<div class="col-6 mx-auto" >
			<div class="row">
				<div class="col-md-4 text-center mt-3">
					<button type="button" class="btn btn-warning" id="kakao-login-btn" style="width: 330px; height:50px; margin-left: 3.5px;" >카카오 아이디로 로그인</button>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 text-center mt-3">
					<button type="button" class="btn btn-primary" style="width: 330px; height:50px; margin-left: 3.5px;">페이스북 아이디로 로그인</button>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 text-center mt-3">
					<button type="button" class="btn btn-success" style="width: 330px; height:50px; margin-left: 3.5px;">네이버 아이디로 로그인</button>
				</div>
			</div>
