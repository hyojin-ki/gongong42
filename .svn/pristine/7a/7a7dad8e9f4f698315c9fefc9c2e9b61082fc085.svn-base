					...
					<div id="generic_price_table">
						...
						<div class="generic_content clearfix">
							...
							<div class="generic_feature_list">
								<ul>
									<li><span>예매내역</span></li>
									<li><span>메이트방</span></li>
									<li><span>나의프로필</span></li>
									<li><span>관심공연</span></li>
									<li><span>나의쿠폰</span></li>
									<li><span>나의포인트</span></li>
								...
								<div class="row">
									...
									<div class="col-3" style="border-right: 1px dotted #fff;">
										...
										<div class="col-12 text-white text-center mt-3">
											<h2>
												<span class="text-warning">${user.coupons.size() }</span>개
											</h2>
										</div>
									</div>
									<div class="col-3">
										...
										<div class="col-12 text-white text-center mt-3">
											<h2>
												<span class="text-warning">${user.point }</span>P
											</h2>
										</div>
									</div>
								</div>
						...
						<div class="mypage-card-header mt-3 ">
							<div class="row">
								...
								<div class="col-3 mt-2 text-right">
									<a href="/mypage/myperformance.do">더보기</a><i class="fas fa-chevron-right"></i>
								</div>
							</div>
						</div>
						<div class="card mt-3">
									...
									<div class="col-3">
										<div class="row">
											...
											<div class="col-12 text-center mt-1">
												<div class="row">
													<div class="col-12">
														<h3 class="font-weight-bold">시카고</h3>
													</div>
													<div class="col-12">
													...
													<div class="col-12">
														...
														<span>2021.05.07</span>~<span>2021.05.08</span>
													</div>
												</div>
											</div>
											...
											<tbody id="qna-main-tbody">
												<tr id="qna-1">
													...
													<td style="text-align: left !important;" class="title"
														id="qna-title">예매는 어떻게 하나요? <span><i
															class="fas fa-lock fa-1x"></i></span></td>
													<td>관리자</td>
													<td>1</td>
													<td>2020.08.08</td>
												</tr>
												<tr>
													<td>2</td>
													<td>이벤트</td>
													<td style="text-align: left !important;">이벤트가 적용되지
														않습니다. <span><i class="fas fa-unlock fa-1x"></i></span>
													</td>
													<td>관리자</td>
													<td>1</td>
													<td>2020.08.08</td>
