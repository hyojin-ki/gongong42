			...
			<div class="col-12">
				...
				<form action="add.do" method="post" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-12 mb-2">
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" class="custom-control-input" id="customRadio6" name="badge" value=2>
								<label class="custom-control-label" for="customRadio6">새소식</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" class="custom-control-input" id="customRadio7" name="badge" value=1>
