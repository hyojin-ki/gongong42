		...
		<div class="row">
			<div class="col-12">
				...
				<!-- EL에서 값 가져오기 -->
					...
					<div class="row" id="category-box">  
						<div class="col-12 mb-2">
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-category-no=0 class="custom-control-input" id="customRadio" name="category" value="서비스소식">
								<label class="custom-control-label" for="customRadio">서비스소식</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-category-no=3 class="custom-control-input" id="customRadio2" name="category" value="서비스안내">
								<label class="custom-control-label" for="customRadio2">서비스안내</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-category-no=1 class="custom-control-input" id="customRadio3" name="category" value="서비스오픈">
								<label class="custom-control-label" for="customRadio3">서비스오픈</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-category-no=2 class="custom-control-input" id="customRadio4" name="category" value="서비스종료">
								<label class="custom-control-label" for="customRadio4">서비스종료</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-category-no=4 class="custom-control-input" id="customRadio5" name="category" value="기타">
					...
					<div class="row" id="badge-box">
						<div class="col-12 mb-2">
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-badge-no=0 class="custom-control-input" id="customRadio6" name="badge" value=0>
								<label class="custom-control-label" for="customRadio6">선택안함</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio" data-badge-no=2 class="custom-control-input" id="customRadio7" name="badge" value=2>
								<label class="custom-control-label" for="customRadio7">새소식</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input type="radio"  data-badge-no=1 class="custom-control-input" id="customRadio8" name="badge" value=1>
...
$(function() {
	...
	$.ajax({
		...
		success : function (notice) {
			...
			console.log(notice.badge)
			console.log(notice.imoticon)
			console.log(notice.images[0].imagePath)
			console.log(notice.insideContents[0].title)
			console.log(notice.insideContents[1].content)
			console.log(notice.insideContents[2].title)
			console.log(notice.insideContents[3].content)
