			...
			<div class="row mt-4 justify-content-center">
				<div class="col-10 border p-3">
					<form method="post" id="addForm" action="step1.do" enctype="multipart/form-data">		
						...
						<div class="form-group">
							<label>공연명</label> 
							<p class="form-error-msg" id="titleError">필수입력칸 입니다.</p>
						...
						<div class="form-group">
							<label>공연장르</label> 
							<p class="form-error-msg" id="genreError">한 개 이상의 장르를 선택해주세요</p>
							<div>
						...
						<div class="form-group">
							<label>주최</label>
							<p class="form-error-msg" id="providerError">필수입력칸 입니다.</p>
							<input type="text" name="provider" class="form-control" />
						</div>
						
						<div class="form-group">
							<label>설명</label>
							<p class="form-error-msg" id="explainError">필수입력칸 입니다.</p>
							<div class="" style="overflow:auto;" >							
								<textarea rows="10" cols="120" name="explain" ></textarea>
							</div>
						</div>
