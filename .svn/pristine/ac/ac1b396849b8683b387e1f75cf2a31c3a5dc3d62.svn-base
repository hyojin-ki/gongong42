...
public class PerformanceUpdateForm {
	// 공연 기본정보
		private int id;
	    ...
	    private String imageSelect; // 기존의 이미지 existing, 새 이미지 new
	    ...
	    public int getOriginalHallId() {
			return originalHallId;
		}
	    
	    public void setOriginalHallId(int originalHallId) {
			this.originalHallId = originalHallId;
		}
}
