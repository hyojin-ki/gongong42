		...
		<div class="row">
			<div class="col-12">
				...
				<div class="row" style="background-color: #f5f5f5; height: 300px;">
					<div class="col-2">
						 <img alt="" src="../resources/sample-images/image1.jpg" style="width: 200px; height: 200px; margin-top: 50px;">
					</div>
					<div class="col-1"></div>
					<div class="col-8">
						<div class="row" style="margin-top: 50px;">
							<div class="col-12">
								<h3 style="font-weight: bolder;">뮤지컬[모차르트]</h3>
							</div>							
						</div>
						<div class="row" style="margin-top: 20px;">
							...
							<div class="col-9" style="margin-left: 20px;">
								<h5 style="font-weight: bolder;">티켓오픈</h5>
								<span style="font-weight: bolder"> 2020.12.32() 오후 1:00</span>
							</div>
						</div>
