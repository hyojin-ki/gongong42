...
<div class="container " style="margin-top: 150px;">
	<div class="row ">
		<div class="col-8 mx-auto" >
			<form:form name="form" method="post" id="sns-signup-form" action="signup.do"  modelAttribute="userSignupForm">
				<div class="card border-0">
					...
					<div class="card-body">
						...
						<div class="form-row border border-top-0 border-right-0 border-left-0">
							<div class="form-group col-md-12">
      							<form:input type="text" class="form-control" id="tel" path="tel" maxlength="13" placeholder="휴대폰 번호를 입력하세요" />
...
$(function(){
	$('#sns-signup-form').submit(function() {
		...
		if (!idRegExp.test(id)) {
			alert("아이디는 영어대소문자, 숫자 조합의 5글자 이상 20글자 이하로 입력하세요")
			return false;
		}
