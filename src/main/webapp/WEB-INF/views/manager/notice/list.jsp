	...
	<div class="container">
		<div class="row card mt-4 mb-4">
			<div class="col-12 mb-2 mt-2	">
				<div class="row">
					<div class="col-12">
						<form id="notice-list-form" class="form-group" method="get" action="/admin/notice/list.do">
													...
													<tr>
														...
														<c:choose>
															<c:when test="${notice.badge eq 0 }">
																<a href="/admin/notice/detail.do?no=${notice.id }">
																<c:out value="${notice.title }"></c:out></a>
															</c:when>
															<c:when test="${notice.badge eq 1 }">
																<span class="badge badge-danger">단독판매</span><a href="/admin/notice/detail.do?no=${notice.id }">
																<c:out value="${notice.title }"></c:out></a>
															</c:when>
															<c:when test="${notice.badge eq 2 }">
																<span class="badge badge-primary">새소식</span><a href="/admin/notice/detail.do?no=${notice.id }">
																<c:out value="${notice.title }"></c:out></a>
															</c:when>
														</c:choose>
														</td>
